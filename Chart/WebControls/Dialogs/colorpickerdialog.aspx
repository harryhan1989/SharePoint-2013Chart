...
<head>
    ...
    <title><asp:Literal runat="server" Text="<%$Resources:mosschart,ColorPickerDialog_aspx_Title_Text%>" /></title>
    <style type="text/css">
		body{
...
<table cellpadding="0" cellspacing="5" border="0">
	<tr>
		<td><asp:Literal runat="server" Text="<%$Resources:mosschart,ColorPickerDialog_aspx_SelectColor_Text%>" /></td>
		<td style="padding:0px 10px 0px 10px"><asp:Literal runat="server" Text="<%$Resources:mosschart,ColorPickerDialog_aspx_CurrentColor_Text%>" /></td>
		<td>&nbsp;</td>
	</tr>
	<tr valign="top">
		<td>
		...
		<td align="center" style="padding:0px 10px 0px 10px">			
			...
			<tr>
				<td align="left"><asp:Literal runat="server" Text="<%$Resources:mosschart,ColorPickerDialog_aspx_RedColor_Text%>" /></td>
				<td><input id="txtR" class="inputColor" onchange="rgba_Change();"/></td>
			</tr>
			<tr>	
				<td align="left"><asp:Literal runat="server" Text="<%$Resources:mosschart,ColorPickerDialog_aspx_GreenColor_Text%>" /></td>
				<td><input id="txtG" class="inputColor" onchange="rgba_Change();" /></td>
			</tr>
			<tr>
				<td align="left"><asp:Literal runat="server" Text="<%$Resources:mosschart,ColorPickerDialog_aspx_BlueColor_Text%>" /></td>
				<td><input id="txtB" class="inputColor" onchange="rgba_Change();" /></td>
			</tr>
			<tr>
				<td align="left"><asp:Literal runat="server" Text="<%$Resources:mosschart,ColorPickerDialog_aspx_Opacity_Text%>" /></td>
		...
		<td>
			<asp:Button ID="btnOK" Text="<%$Resources:mosschart,ColorPickerDialog_aspx_OK_Text%>" runat="server" class="dialogButton" onclientclick="SaveUI()" /><br>
			<br>
			<asp:Button ID="btnCancel" Text="<%$Resources:mosschart,ColorPickerDialog_aspx_Cancel_Text%>" runat="server" class="dialogButton" onclientclick="window.close();" /><br>
